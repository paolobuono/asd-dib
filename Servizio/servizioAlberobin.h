...
void ordina_albero(Coda<T> &c, Albero_bin<T> & t, Albero_bin<T> & a, Nodo<T>* pos_1){            //legge gli elementi della coda e per ciascuno di essi                 c=costruisci_coda(c, t, pos_1);                                                                  //chiama la funzione di inserimento
  T e;
