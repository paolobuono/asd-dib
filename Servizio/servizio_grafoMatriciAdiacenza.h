...
#ifndef SERVIZIO_GRAFOMATRICIADIACENZA_H_
#define SERVIZIO_GRAFOMATRICIADIACENZA_H_
...
void servizio_grafoMatriciAdiacenza();

void servizio_grafoMatriciAdiacenza() {

	GrafoMatriceAdiacenza<int, int> grafoInteri;
	...
	grafoInteri.insArco(0, 1, 0);
	grafoInteri.insArco(1, 3, 1);
	grafoInteri.insArco(3, 5, 2);
	grafoInteri.insArco(5, 4, 3);
	grafoInteri.insArco(4, 2, 4);
	grafoInteri.insArco(2, 0, 5);
...
#endif /* SERVIZIO_GRAFOMATRICIADIACENZA_H_ */
